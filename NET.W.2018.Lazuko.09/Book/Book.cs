...
namespace BookLogic
{
    ...
    public class Book : IFormattable
    {
        ...
        /// <summary>
        /// Implementation of IFormattable.ToString method.
        /// </summary>
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            {
                case "A":
                    return $"Author: {Author}, Title: {Name}.";
                case "B":
                    return $"Author: {Author}, Title: {Name}, Publishing House: {PublishingHouse}, Publishing Year: {PublishingYear}.";
                case "C":
                    return $"ISBN: {ISBN}, Author: {Author}, Title: {Name}, Publishing House: {PublishingHouse}, Publishing Year: {PublishingYear}, P: {PagesNumber}.";
                case "D":
                    return $"Author: {Author}, Title: {Name} ({PublishingYear})";
                case "G":
                    return $"ISBN: {ISBN}, Author: {Author}, Title: {Name}, Publishing House: {PublishingHouse}, Publishing Year: {PublishingYear}, P: {PagesNumber}, Cost: {Price}.";
                default:
